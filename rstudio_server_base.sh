...
sudo dnf -y install https://download2.rstudio.org/server/rhel8/x86_64/rstudio-server-rhel-2022.07.2-576-x86_64.rpm
...
sudo dnf -y install libxml2-devel openssl-devel
