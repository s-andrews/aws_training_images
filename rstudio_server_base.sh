...
sudo dnf -y install libxml2-devel openssl-devel fontconfig-devel harfbuzz-devel fribidi-devel  freetype-devel libpng-devel libtiff-devel libjpeg-turbo-devel cmake
